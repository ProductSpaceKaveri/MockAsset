...
public class Image extends system.proxies.FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.Assets", mendixObject.getType())) {
		...
		if (com.mendix.core.Core.isSubClassOf("MyFirstModule.SubAsset", mendixObject.getType())) {
			return myfirstmodule.proxies.SubAsset.initialize(context, mendixObject);
		}
		if (com.mendix.core.Core.isSubClassOf("Barcode.TestOutput", mendixObject.getType())) {
